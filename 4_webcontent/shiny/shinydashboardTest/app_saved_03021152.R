                           ...
                           tabPanel(title = "Map",
                                    fluidRow(
                                            ...
                                            column(width = 4,
                                                   ...
                                                   fluidRow(
                                                           column(width = 5,
                                                                  actionButton(inputId = "apply_m1",label = "Apply Changes",icon = icon(name = "refresh"))),
                                                           column(width = 1,
                                                                  ""),
                                                           column(width = 6,
...
# +-- Controls ------------------------------------
                                                    fluidRow(
                                                        ...
                                                        wellPanel(fluidRow(
                                                                column(width = 4,
                                                                        h3(HTML("<br>")),
                                                                        actionButton(inputId = "apply",label = "Apply Changes",icon = icon(name = "refresh"))),
                                                                 column(width = 3,
                                                                        h6(HTML("<br>")),
                                                                        selectInput(inputId = "input_type",label = "",choices = c("slider","numeric"))),
                                                                 column(width = 4,
                                                                        h3(HTML("<br>")),
...
# +-- UI Switch (Map2) ---------
        ...
        output$capfla_low <- renderUI({
                ...
                switch(input$input_type,
                       ...
                       "numeric" =  numericInput("capfla_low", "Max. Fl. Area",
        ...
        output$capfla_hi <- renderUI({
                ...
                switch(input$input_type,
                       "numeric" =  numericInput("capfla_hi", " ",
        ...
        output$landval_low <- renderUI({
                ...
                switch(input$input_type,
                       ...
                       "numeric" =  numericInput("landval_low", "Appr. Land $",
        ...
        output$landval_hi <- renderUI({
                ...
                switch(input$input_type,
                       "numeric" =  numericInput("landval_hi", " ",
