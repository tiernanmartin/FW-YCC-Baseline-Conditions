                                    ...
                                    column(1,
                                           ...
                                           div(style = "font-size: 150%; position: absolute; left: -5px; top: 110px;",
                                               ...
                                               HTML("
                                                    ...
                                                    ")),
                                           div(style = "font-size: 150%; position: absolute; left: -5px; top: 145px;",
                                               title = "Turn on pin clusteres",
                                               HTML("
                                                    <button id='clusters' type='button' class='action-button'><i class='fa fa-circle-o'></i></button>
                                                    "))
                                               )),
