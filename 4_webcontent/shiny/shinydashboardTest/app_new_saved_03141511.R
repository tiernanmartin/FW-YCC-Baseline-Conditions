        ...
        bootstrapPage(
                ...
                tags$head(tags$style(
                        HTML('
                             ...
                             '))),
                tags$div(class = 'outer', DT::dataTableOutput("table2",width = "100%"))
...
server <- function(input, output) {
        ...
        output$table1 <- renderDataTable(server = FALSE, selection = 'single',{
                quakes %>% DT::datatable(extensions = 'Responsive',
                                         class = 'table table-condensed',
                                         options = list(pageLength = 5))
        })
        
        output$table2 <- renderDataTable(server = FALSE, selection = 'single',{
                quakes %>% DT::datatable(extensions = 'Responsive',
                                         class = 'table table-condensed',
                                         options = list(pageLength = 5))
        })
