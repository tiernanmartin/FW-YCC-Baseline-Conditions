...
# ---- +--- Sidebar Panel Content ---------
                            ...
                            fluidRow(
                                    column(11,
                                           sidebarMenu(id = "menu",
                                                   ...
                                                   menuItem("Parcel Categories", tabName = "categories", icon = icon("list")),
                                                   menuItem("Neighborhoods", tabName = "hoods", icon = icon("list")),
                            ...
                            #         column(1)
                            # ),
                            conditionalPanel(condition = "input.menu == 'table'",
                                             fluidRow(
                                                     column(10,offset = 1,
